...
<div class="header">
    ...
    <h2 style="padding-left:800px; color: white;text-shadow: 4px 4px 5px #000000">RESERVED</h2>
        <h3 style="padding-left:80px;">Park Only</h3>
        <a href="b1occupied.php"><img class="img" src="images/car-park.png"></a>
        <hr>
        <h3 style="padding-left:30px;">Park With Car Wash</h3>
        <a href="b2occupied.php"><img class="img" src="images/car-wash.png"></a>
    </form>
</div>
